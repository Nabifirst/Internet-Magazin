  ...
  return (
    ...
    <div className='m-auto flex flex-col gap-[40px] w-[371px]'>
      ...
      <div className='flex justify-between items-center'>
        <button onClick={() => Login()} className='w-[143px] h-[56px] rounded-[4px] bg-[#1976D2] hover:bg-[#1565C0] text-[#FAFAFA] text-[16px] font-medium leading-[24px]'>Log In</button>
        <span className='text-[#1976D2] hover:text-[#1565C0] text-[16px] leading-[24px] cursor-pointer'>Forget Password?</span>
      </div>
    </div>
    </>
  )
